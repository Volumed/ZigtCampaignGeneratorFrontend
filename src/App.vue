<template>
  <v-app class="white">
    <v-navigation-drawer v-model="drawer" absolute right temporary>
      <v-list nav dense>
        <v-list-item-group v-model="group" active-class="secondary--text text--accent-4">
          <v-list-item to="/">
    ...
    <v-app-bar app :collapse="!collapseOnScroll" :collapse-on-scroll="collapseOnScroll" absolute color="primary" scroll-target="#scrolling-techniques-6">
      <router-link to="/" class="home"><img class="logo" src="./assets/logo.svg" /></router-link>
      <v-spacer></v-spacer>
    ...
    <v-content>
      <v-container fluid>
        <div id="scrolling-techniques-6"></div>
